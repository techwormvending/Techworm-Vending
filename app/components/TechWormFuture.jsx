...
export default function TechWormFuture() {
  ...
  return (
    <div className="min-h-screen bg-black text-white overflow-hidden">
      ...
      <section className="relative z-10 border-t border-cyan-500/20 py-24">
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid md:grid-cols-2 gap-16 items-center">
            <div className={`transition-all duration-1000 ${isLoaded ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-8'}`}
              style={{ transitionDelay: '300ms' }}>
              <div className="bg-gradient-to-br from-purple-500/10 to-cyan-500/10 border border-purple-500/30 rounded-2xl p-12 backdrop-blur-sm">
                <div className="text-center">
                  <div className="text-6xl mb-4">📱</div>
                  <p className="text-sm text-slate-400 mb-6">Real-Time Dashboard</p>
                  <div className="space-y-3 text-sm text-slate-300">
                    <p>✓ Live inventory tracking</p>
                    <p>✓ Sales data instantly</p>
            ...
            <div className={`transition-all duration-1000 ${isLoaded ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-8'}`}
              style={{ transitionDelay: '400ms' }}>
              <p className="text-purple-400 font-black text-sm mb-4 tracking-widest">INSTANT VISIBILITY</p>
              <h2 className="text-5xl md:text-6xl font-black mb-6 leading-tight">
                Know Everything. <span className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-purple-400">Instantly</span>
              </h2>
              <p className="text-lg text-slate-300 mb-8 leading-relaxed">
                Every transaction. Every item sold. Every moment. Your dashboard shows it all in real-time. Make data-driven decisions instantly.
              </p>
              <ul className="space-y-4">
                {[
                  'Item-level tracking (99.9% accuracy)',
                  'Sales velocity by product',
                  'Customer demand patterns',
                  'Revenue per location',
                  'Profit analysis by machine'
                ].map((item, i) => (
                  <li key={i} className="flex items-center gap-3">
      ...
      <section className="relative z-10 border-t border-cyan-500/20 py-24 bg-gradient-to-b from-black to-slate-900/50">
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid md:grid-cols-2 gap-16 items-center">
            <div className={`transition-all duration-1000 ${isLoaded ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-8'}`}
              style={{ transitionDelay: '300ms' }}>
              <p className="text-emerald-400 font-black text-sm mb-4 tracking-widest">INSTANT CUSTOMER SERVICE</p>
              <h2 className="text-5xl md:text-6xl font-black mb-6 leading-tight">
                Customer Service. <span className="text-transparent bg-clip-text bg-gradient-to-r from-emerald-400 to-cyan-400">In Their Pocket</span>
              </h2>
              <p className="text-lg text-slate-300 mb-8 leading-relaxed">
                WhatsApp messaging groups. Instant notifications. Real-time support. Customers text us directly about items they want. We listen. We respond. We improve.
              </p>
              <div className="space-y-4">
                <div className="p-4 bg-slate-800/50 rounded-lg border border-emerald-500/20">
                  <p className="text-emerald-400 font-bold text-sm mb-2">Customer Requests</p>
                  <p className="text-slate-300 text-sm">"Can you stock energy drinks?" → We add them next restock</p>
                </div>
                <div className="p-4 bg-slate-800/50 rounded-lg border border-emerald-500/20">
                  <p className="text-emerald-400 font-bold text-sm mb-2">Instant Feedback</p>
                  <p className="text-slate-300 text-sm">Products running low? Customers tell us immediately</p>
                </div>
                <div className="p-4 bg-slate-800/50 rounded-lg border border-emerald-500/20">
                  <p className="text-emerald-400 font-bold text-sm mb-2">Community Building</p>
                  <p className="text-slate-300 text-sm">Group discussions about preferences & promotions</p>
                </div>
              </div>
            </div>
            ...
            <div className={`transition-all duration-1000 ${isLoaded ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-8'}`}
              style={{ transitionDelay: '400ms' }}>
              <div className="bg-gradient-to-br from-emerald-500/10 to-cyan-500/10 border border-emerald-500/30 rounded-2xl p-12 backdrop-blur-sm">
                <div className="flex items-center gap-3 mb-8">
                  <MessageCircle className="w-8 h-8 text-emerald-400" />
                  <h3 className="text-2xl font-black text-white">24/7 Connected</h3>
                </div>
                <div className="space-y-4">
                  <div>
                    <p className="text-sm text-emerald-400 font-bold mb-2">Response Time</p>
                    <p className="text-3xl font-black text-white">Instant</p>
                  </div>
                  <div>
                    <p className="text-sm text-emerald-400 font-bold mb-2">Customer Engagement</p>
                    <p className="text-3xl font-black text-white">Direct</p>
                  </div>
                  <div>
                    <p className="text-sm text-emerald-400 font-bold mb-2">Group Size</p>
                    <p className="text-3xl font-black text-white">No Limit</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section className="relative z-10 border-t border-cyan-500/20 py-24 bg-gradient-to-b from-slate-900/50 to-black">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="text-5xl md:text-6xl font-black mb-6">
              The <span className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-purple-400">Perfect Combination</span>
            </h2>
          </div>

          <div className="grid md:grid-cols-4 gap-6">
            {[
              { num: '5X', label: 'More Revenue', color: 'from-cyan-400 to-blue-500' },
              { num: '20X', label: 'More Variety', color: 'from-purple-400 to-pink-500' },
              { num: '40%', label: 'Less Stocking Time', color: 'from-green-400 to-emerald-500' },
              { num: '99.9%', label: 'AI Accuracy', color: 'from-orange-400 to-red-500' }
            ].map((stat, idx) => (
              <div
                key={idx}
                className={`p-8 rounded-xl bg-gradient-to-br ${stat.color} bg-opacity-10 border border-cyan-500/20 text-center transition-all duration-1000 hover:scale-105 ${
                  isLoaded ? 'opacity-100 scale-100' : 'opacity-0 scale-95'
                }`}
                style={{ transitionDelay: `${300 + idx * 100}ms` }}
              >
                <p className="text-4xl font-black text-white mb-2">{stat.num}</p>
        ...
        <div className="rounded-2xl overflow-hidden border border-cyan-500/30">
          ...
          <div className="relative p-12 md:p-16 text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <a href="https://wa.me/your-number" className="px-8 py-4 bg-slate-800 border-2 border-emerald-500/40 text-emerald-400 rounded-lg font-bold text-lg hover:border-emerald-500 hover:bg-slate-700 transition-all flex items-center justify-center gap-2">
